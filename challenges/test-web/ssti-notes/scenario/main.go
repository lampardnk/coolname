				...
				Template: &corev1.PodTemplateSpecArgs{
					...
					Spec: &corev1.PodSpecArgs{
						Containers: corev1.ContainerArray{&corev1.ContainerArgs{
							...
							Image: pulumi.String("asia-southeast1-docker.pkg.dev/project-37bfe636-96dd-4d8c-b26/ctf-images/ssti-notes:latest"),
							Ports: corev1.ContainerPortArray{
								&corev1.ContainerPortArgs{ContainerPort: pulumi.Int(8080)},
							},
							// FLAG injected as Kubernetes env var — tests that scenario
							// correctly propagates secrets into pod environment at instance creation time.
							Env: corev1.EnvVarArray{
								&corev1.EnvVarArgs{
									Name:  pulumi.String("FLAG"),
