...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		// Node.js app listens on 3000 — tests non-8080 container port routing
		containerPort := 3000
				...
				Template: &corev1.PodTemplateSpecArgs{
					...
					Spec: &corev1.PodSpecArgs{
						Containers: corev1.ContainerArray{&corev1.ContainerArgs{
							...
							Image: pulumi.String("asia-southeast1-docker.pkg.dev/project-37bfe636-96dd-4d8c-b26/ctf-images/jwt-admin:latest"),
