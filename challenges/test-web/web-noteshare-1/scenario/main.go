				...
				Template: &corev1.PodTemplateSpecArgs{
					...
					Spec: &corev1.PodSpecArgs{
						Containers: corev1.ContainerArray{&corev1.ContainerArgs{
							...
							Image: pulumi.String("asia-southeast1-docker.pkg.dev/project-37bfe636-96dd-4d8c-b26/ctf-images/web-noteshare-1:latest"),
							Ports: corev1.ContainerPortArray{
								&corev1.ContainerPortArgs{ContainerPort: pulumi.Int(8080)},
							},
							Env: corev1.EnvVarArray{
								&corev1.EnvVarArgs{
									Name:  pulumi.String("FLAG1"),
									Value: pulumi.String("CTF{robots_txt_is_not_a_security_measure}"),
								},
								&corev1.EnvVarArgs{
									Name:  pulumi.String("FLAG2"),
									Value: pulumi.String("CTF{cookies_are_not_authentication}"),
								},
								&corev1.EnvVarArgs{
									Name:  pulumi.String("FLAG3"),
									Value: pulumi.String("CTF{sql_injection_bypasses_login}"),
								},
								&corev1.EnvVarArgs{
									Name:  pulumi.String("FLAG4"),
									Value: pulumi.String("CTF{ssti_jinja2_config_leak}"),
								},
								&corev1.EnvVarArgs{
									Name:  pulumi.String("FLAG5"),
									Value: pulumi.String("CTF{path_traversal_reads_arbitrary_files}"),
								},
							},
